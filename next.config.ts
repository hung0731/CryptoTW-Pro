        ...
        headers: [
          ...
          // 優化的 Content Security Policy
          {
            ...
            value: [
              ...
              "connect-src 'self' *.supabase.co *.google-analytics.com https://api.coinglass.com https://open-api.coinglass.com wss://*.supabase.co *.line.me https://*.line.me https://access.line.me",

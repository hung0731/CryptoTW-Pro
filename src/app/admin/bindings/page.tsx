...
import { Check, X, RefreshCw, User, Download } from 'lucide-react'
...
export default function BindingsPage() {
    ...
    // TODO: Move export logic to this page's context if needed or keep global
    const handleExport = () => {
    ...
    return (
        <div className="p-6 md:p-8 space-y-8 w-full">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-white">交易所綁定 (Bindings)</h1>
                    <p className="text-neutral-400 mt-2">審核用戶提交的交易所與 UID</p>
                </div>

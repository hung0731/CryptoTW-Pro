...
import { ArrowRight, Bell, Zap, FileText, Lock, ChevronRight, UserPlus, Link as LinkIcon, CheckCircle } from 'lucide-react'
...
export default function FeedPage() {
    ...
    useEffect(() => {
        ...
        if (isPro) {
            ...
            setDataLoading(false) // Stop loading if not pro
        }

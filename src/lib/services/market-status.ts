...
import { MarketStatusResponse } from '@/lib/schemas/market';

export class MarketStatusService {
    /**
     * Fetches and calculates the current market status.
     * This logic was extracted from /api/market/status/route.ts
     */
    static async getMarketStatus(): Promise<MarketStatusResponse | null> {
        try {
            ...
            const status = {
                ...
                long_short: { ratio: 1.1 }, // Default or mapped if available
            ...
            logger.error('MarketStatusService Error', e);
            return null;
        }
    }
}
